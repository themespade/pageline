...
class Pageline_Testimonials_Widget extends WP_Widget {
                  ...
                  <?php  while ($get_featured_posts->have_posts()) : $get_featured_posts->the_post();  ?>
                    <div class="testimonial item">
                        ...
                        <div class="nnc-dtl-info">
                            <?php the_content(); ?>
                          <?php if ( isset($designation_array[$i]) && !empty( $designation_array[$i] ) ) {
                              echo '<span>'.esc_attr( $designation_array[$i] ).'</span>';
                          } ?>
 ...
 <?php for ($i = 0; $i <= 6; $i++) : ?>
      ...
      <p><label for="<?php echo $this->get_field_id('designation_'.$i); ?>"><?php esc_html_e( 'Designation:', 'pageline' ); ?></label>
      <input class="widefat" id="<?php echo $this->get_field_id('designation_'.$i); ?>" name="<?php echo $this->get_field_name('designation_'.$i); ?>" type="text" value="<?php echo esc_attr($instance['designation_'.$i]); ?>" /></p>
